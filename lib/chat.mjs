...
// Public view of a message for chat clients (no pipeline internals). Deleted
// messages (ruling 12) render as a WhatsApp-style placeholder: no content, no
// media, only the fact of deletion.
