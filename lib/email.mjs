...
const WELCOME_TEMPLATES = {
  en: (name, url) => ({
    ...
    text:
      ...
      `Important: do not open it inside the email app itself; use the real browser.\n\n` +
  ...
  ru: (name, url) => ({
    ...
    text:
      ...
      `Vazhno: ne otkryvayte ego vnutri pochtovogo prilozheniya, ispolzuyte obychnyy brauzer.\n\n` +
  ...
  az: (name, url) => ({
    ...
    text:
      ...
      `Vacib: unvani email tetbiqinin ichinde achmayin, adi brauzerden istifade edin.\n\n` +
