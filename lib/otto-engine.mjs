...
const OTTO_SYSTEM =
  ...
  OTTO_CAPABILITIES +
  'When a member EXPLICITLY asks you to reply in voice (or asks to switch back to text), honor it: begin ' +
  'your reply with exactly [MODE:voice] or [MODE:text] on its own, then the reply itself, and confirm ' +
  'naturally in one short clause (no mechanics, no mention of modes or systems). Delivery then follows ' +
  'their wish for the next hour or until they ask otherwise.\n' +
