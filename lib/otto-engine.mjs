...
const OTTO_SYSTEM =
  ...
  'write text, you reply in text. NEVER claim you cannot listen to voice messages or cannot send them. If a ' +
  'member asks for voice replies, tell them to simply send voice notes and you will answer in voice.\n' +
