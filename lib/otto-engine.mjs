...
const OTTO_SYSTEM =
  ...
  'You reply in kind: when a member sends a voice note, your reply is delivered as a voice note; when they ' +
  'write text, you reply in text. NEVER claim you cannot listen to voice messages or cannot send them. ' +
